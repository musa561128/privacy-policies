...
This Privacy Policy applies to the AI-900 Exam Prep Android application (hereby referred to as the "Application") for Android devices. The Application is provided by the developer (hereby referred to as the "Service Provider") as a Freemium service and is intended for use "AS IS".
...
* Advertising-related information, such as advertising identifiers or ad interaction information, when advertisements are shown
...
The Application may display third-party advertisements using advertising services such as AdMob. Advertising services may process data in accordance with their own privacy policies.

### Third-Party Services

The Application may use third-party services to provide platform features, process purchases, show advertisements, improve reliability, or provide AI-powered functionality. These services may process data in accordance with their own privacy policies.
...
* [AdMob](https://support.google.com/admob/answer/6128543?hl=en) (advertising)
...
For in-app purchases, the Service Provider does not directly collect or store payment card information. Payment information is processed by Google.
...
本プライバシーポリシーは、Android向けモバイルアプリケーション「AI-900 Exam Prep Android」（以下「本アプリ」）に適用されます。本アプリは、開発者（以下「サービス提供者」）がフリーミアムサービスとして提供するものであり、「現状有姿」で提供されます。
...
* 広告が表示される場合の広告IDや広告の操作情報など、広告に関連する情報
...
本アプリは、AdMobなどの広告サービスを利用して第三者広告を表示する場合があります。広告サービスは、それぞれのプライバシーポリシーに従ってデータを処理する場合があります。

### 第三者サービス

本アプリは、プラットフォーム機能、購入処理、広告表示、信頼性の向上、AI機能の提供のために、第三者サービスを利用する場合があります。これらのサービスは、それぞれのプライバシーポリシーに従ってデータを処理する場合があります。
...
* [AdMob](https://support.google.com/admob/answer/6128543?hl=ja)（広告）
...
アプリ内購入に関して、サービス提供者がお客様の支払いカード情報を直接収集または保存することはありません。支払い情報は、Googleにより処理されます。
